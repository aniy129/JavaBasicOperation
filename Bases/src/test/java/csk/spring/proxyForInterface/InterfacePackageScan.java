...
/**
 * 扫描指定包下的接口，并动态创建实例且注册到容器中
 */
public class InterfacePackageScan extends ClassPathBeanDefinitionScanner {


    public InterfacePackageScan(BeanDefinitionRegistry registry) {
...
//                return className.endsWith(DEFAULT_MAPPER_SUFFIX);
    ...
    void processBeanDefinitions(Set<BeanDefinitionHolder> beanDefinitions) {
        ...
        for (BeanDefinitionHolder holder : beanDefinitions) {
            ...
            definition.setBeanClass(BaseProxyBean.class);
            // 设置按照接口组装
